...
#import "GANChartDelegate.h"

#if __IPHONE_OS_VERSION_MAX_ALLOWED < __IPHONE_10_0
@interface GANPieChart : GANGenericChart
#else
@interface GANPieChart : GANGenericChart <CAAnimationDelegate>
#endif
...
@property (nonatomic, weak) id<GANChartDelegate> delegate;
